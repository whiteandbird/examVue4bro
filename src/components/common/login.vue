        ...
        <div class="bottom">
          <div class="container">
            ...
            <el-form :label-position="labelPosition" label-width="80px" :model="formLabelAlign">
              ...
              <div class="role">
                <el-radio v-model="formLabelAlign.type" label="0">管理员</el-radio>
                <el-radio v-model="formLabelAlign.type" label="1">用户</el-radio>
              </div>
              <div class="submit">
  ...
  methods: {
    ...
    login() {
      ...
      this.$axios({
        ...
        console.log("===========enter  login===========token====", localStorage.getItem('token'))
        console.log(resData)
        if(resData != null) {
          ...
          switch(resData.role) {
            ...
            case 1: //教师
              ...
              this.$router.push({path: '/student' }) //跳转到教师用户
              break
          }
        }
